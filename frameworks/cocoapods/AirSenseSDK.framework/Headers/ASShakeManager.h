...
@interface ASShakeManager : NSObject
 ...
 * @param failure Failure callback.
 */
+ (void)getProductUrlByProductId:(unsigned long long)productId success:(void(^)(NSString *productUrl))success failure:(void(^)(ASError *error))failure;
